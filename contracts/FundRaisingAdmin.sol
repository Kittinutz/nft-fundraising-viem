...
contract FundRaisingAdmin is Ownable {
    ...
    function emergencyWithdraw(uint256 amount) external onlyOwner {
        ...
        require(
            coreContract.usdtToken().transferFrom(address(coreContract), owner(), amount),
    ...
    function batchSetRoundActive(
        ...
        for (uint256 i = 0; i < roundIds.length; i++) {
            // This would call the core contract's setRoundActive function
            // For demonstration purposes, we'll emit an event
        }
    }
